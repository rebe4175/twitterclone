...
<body>
    <div id="signupPage">
        <div id="left">
            <div id="leftText">
                <p><span><svg viewBox="0 0 24 24" class="svg">
                            <g>
                                <path
                                    d="M21.53 20.47l-3.66-3.66C19.195 15.24 20 13.214 20 11c0-4.97-4.03-9-9-9s-9 4.03-9 9 4.03 9 9 9c2.215 0 4.24-.804 5.808-2.13l3.66 3.66c.147.146.34.22.53.22s.385-.073.53-.22c.295-.293.295-.767.002-1.06zM3.5 11c0-4.135 3.365-7.5 7.5-7.5s7.5 3.365 7.5 7.5-3.365 7.5-7.5 7.5-7.5-3.365-7.5-7.5z">
                                </path>
                            </g>
                        </svg></span>Follow your interest</p>
                <p><span><svg viewBox="0 0 24 24"
                        ...
                        </svg></span>See what people are talking about</p>
                <p><span><svg viewBox="0 0 24 24"
                            class="r-jwli3a r-4qtqp9 r-yyyyoo r-1q142lx r-1blvdjr r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
                            <g>
                                <path
                        ...
                        </svg></span>Participate in the conversation</p>
            </div>
        </div>
        <div id="right">
            <div id="rightElements">
                <svg viewBox="0 0 24 24" class="logoSvg">
                    <g>
                        <path
                ...
                <P>See whats happening in the world right now</p>
                <p>
                <P>Sign up now</p>
                </p>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="signup-action.php">
                <input name="firstName" type="text" placeholder="First name" value="a" required>
                <input name="lastName" type="text" placeholder="Last name" value="b" required>
                <input id="userEmail" name="email" type="email" placeholder="E-mail" value="a@a.com">
