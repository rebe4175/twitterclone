...
<body>
    ...
    <div id="page">
        ...
        <div id="left">
            ...
            <div id="myModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <form class="formTweet" method="POST" action="api-create-tweet.php" onsubmit="tweet(); return false">
                    <input type="text" name="tweetMessage" placeholder="Whats happening?" value="Whats happening?">
                     <button>tweet</button>
                    </form>
        ...
        <div id="explore" class="subpage">P</div>
